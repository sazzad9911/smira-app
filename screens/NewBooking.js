...
const NewBooking = (props) => {
    ...
    const Confirm = () => {
        ...
        postData(url + '/setData', {
            ...
            values: [convertDate(CheckIn), convertDate(CheckOut), count, count1, count2, convertDate(new Date()), auth.currentUser.uid, props.id,Select]
        }).then(data => {
            if (data.insertId) {
                setLoader(false)
                setConfirm(true)
            ...
            <View style={{
                ...
                <ScrollView>
                    <View style={style.view}>
                        ...
                        <Text style={style.Text1}>{props.address}</Text>
                    </View>
