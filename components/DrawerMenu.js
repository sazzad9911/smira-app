        ...
        <ScrollView style={{ backgroundColor: backgroundColor(darkMode) }} showsVerticalScrollIndicator={false}
            ...
            <View style={[styles.container]}>
                <TouchableOpacity style={[styles.metaContainer]}
                    onPress={() => onNavigate('Account')}>
                    {
                        ...
                        style={[styles.profilePicture]} />
                            ...
                            <Ionicons name='ios-camera-outline' size={40} style={[{ color: '#C1C1C1' }]} />
                            </View>
                        )
                    }
                ...
                <TouchableOpacity style={[styles.navTab]} onPress={() => {
                    ...
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M1.35 6.00002V10.8C1.35 14.0309 3.96913 16.65 7.2 16.65H10.8C14.0309 16.65 16.65 14.0309 16.65 10.8V6.00002H1.35ZM0.9 4.65002C0.402944 4.65002 0 5.05297 0 5.55002V10.8C0 14.7765 3.22355 18 7.2 18H10.8C14.7764 18 18 14.7765 18 10.8V5.55002C18 5.05297 17.5971 4.65002 17.1 4.65002H0.9Z" fill="#C1C1C1"/>
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M12.6667 1.35H5.33332C3.36639 1.35 1.73243 2.77565 1.40839 4.64999H16.5916C16.2676 2.77565 14.6336 1.35 12.6667 1.35ZM5.33332 0C2.38781 0 0 2.38781 0 5.33333C0 5.70151 0.298477 5.99999 0.666666 5.99999H17.3333C17.7015 5.99999 18 5.70151 18 5.33333C18 2.38781 15.6122 0 12.6667 0H5.33332Z" fill="#C1C1C1"/>
                    </svg>`}
                        height="22"
                        width="22" />
                ...
                <TouchableOpacity style={[styles.navTab]} onPress={() => {
                    Linking.openURL('https://play.google.com/store/apps/details?id=com.scientistx.smira')
                }}>
                    <SvgXml
                        style={[styles.tabIco]}
                        xml={`<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
